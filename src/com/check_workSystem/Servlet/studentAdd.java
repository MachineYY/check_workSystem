...
public class studentAdd extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		      ...
		      String sql="insert into student(stu_no,stu_name,stu_pwd,stu_sex,stu_class,stu_marjor,stu_tel) values(?,?,?,?,?,?,?)";
		      java.sql.PreparedStatement ps=conn.prepareStatement(sql);
		      ps.setString(1,stu_no);
	          ps.setString(2,stu_name);
		      ps.setString(3,stu_pwd);
		      ps.setString(4,stu_sex);
		      ps.setString(5,stu_class);
		      ps.setString(6,stu_marjor);
	    	...
	    	out.println("</body>");
	    	out.println("</html>");
	    	response.setHeader("refresh", "0;url=studentAdd.jsp");
		}
