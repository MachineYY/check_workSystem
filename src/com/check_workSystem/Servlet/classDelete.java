...
public class classDelete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		      ...
		      String sql="delete from class where stu_class=?";
	    	  ...
	    	  out.println("<body>");
	    	  out.println("<script language='javaScript'> alert('删除班级成功！');</script>");
	    	  out.println("</body>");
	    	  out.println("</html>");
	    	...
	    	out.println("<html>");//输出的内容要放在HTML中
	    	out.println("<body>");
	    	out.println("<script language='javaScript'> alert('删除班级失败！请重试！');</script>");
	    	out.println("</body>");
	    	out.println("</html>");
	    	response.setHeader("refresh", "0;url=mange_class");
		}
