...
/**
 * Servlet implementation class adminAgreefree
 */
@WebServlet("/adminAgreefree")
public class adminAgreefree extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminAgreefree() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    	  ...
	    	  out.println("<body>");
	    	  out.println("<script language='javaScript'> alert('同意申请成功！');</script>");
	    	  out.println("</body>");
	    	  out.println("</html>");
	    	...
	    	out.println("<html>");//输出的内容要放在HTML中
	    	out.println("<body>");
	    	out.println("<script language='javaScript'> alert('同意申请失败！请重试！');</script>");
	    	out.println("</body>");
	    	out.println("</html>");
	    	response.setHeader("refresh", "0;url=adminFreelist");
		}
